...
@section('breadcrumbs', Breadcrumbs::render('view-seating-plan'))
...
<body>
    ...
    <div class="container my-5">
        ...
        <!-- Week Selection Form -->
        <form method="GET" action="{{ route('trainee-view-seating-plan') }}" class="text-center mb-4">
        ...
        <small>**The highlighted row indicates your seat for this week.</small>
                        ...
                        <table class="table table-bordered table-striped">
                            ...
                            <tbody>
                                @foreach ($selectedSeatingDetails as $seatCode => $assignedTo)
                                    <!-- Highlight row if assignedTo matches $traineeName -->
                                    @if($assignedTo == $traineeName)
                                    <tr>
                                        <td style="background-color: #fff8b3;">{{ $seatCode }}</td>
                                        <td style="background-color: #fff8b3;">{{ $assignedTo }}</td>
                                    </tr>
                                    @else
                                    <tr>
                                        <td>{{ $seatCode }}</td>
