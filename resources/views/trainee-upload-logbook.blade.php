            ...
            <div class="modal fade" id="dateModal" tabindex="-1" aria-labelledby="dateModalLabel" aria-hidden="true">
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <form id="dateSelectionForm" action="{{ route('generate-logbook') }}" method="GET" target="_blank" onsubmit="openReportInNewTab(event)">
                                @csrf
                                <div class="mb-3">
                                ...
                                <li class="logbook-card">
                                    <div class="card">
                                        <div class="card-body">
                                            ...
                                            <button type="button" class="delete-logbook-button" data-toggle="modal" data-target="#confirmationModalUnsigned-{{ $logbook->id }}">
                                            ...
                                            <div class="modal" tabindex="-1" role="dialog" id="confirmationModalUnsigned-{{ $logbook->id }}">
                                ...
                                <li class="logbook-card">
                                    <div class="card">
                                        <div class="card-body">
                                            ...
                                            <button type="button" class="delete-logbook-button" data-toggle="modal" data-target="#confirmationModalSigned-{{ $logbook->id }}">
                                                <i class="fas fa-trash-alt"></i> 
                                            </button>
                                            ...
                                            <div class="modal" tabindex="-1" role="dialog" id="confirmationModalSigned-{{ $logbook->id }}">
                                                <div class="modal-dialog" role="document">
                                                    <div class="modal-content">
                                                        <div class="modal-header">
                                                            <h5 class="modal-title">Confirmation</h5>
