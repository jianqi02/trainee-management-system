    ...
    <div class="content">
        <div class="logbook-container">
            ...
            <div class="modal fade" id="dateModal" tabindex="-1" aria-labelledby="dateModalLabel" aria-hidden="true">
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <form id="dateSelectionForm" action="{{ route('admin-generate-logbook', ['traineeName' => $name]) }}" method="GET" target="_blank" onsubmit="openReportInNewTab(event)">
                                @csrf
                                <div class="mb-3">
            ...
            <ul class="nav nav-tabs" id="logbookTabs" role="tablist">
                <li class="nav-item">
                    <a class="nav-link active" id="unsigned-tab" data-bs-toggle="tab" data-bs-target="#unsigned" type="button" role="tab" aria-controls="unsigned" aria-selected="true">
                        Unsigned
                    </a>
                </li>
                <li class="nav-item">
