    ...
    <div class="task-container">
        <div class="row">
            ...
            <div class="col-md-8">
                ...
                <button type="button" id="commentButton" class="btn btn-primary" style="padding: 7px; height: 40px;">Edit Comment</button>
                ...
                <div id="commentModal" class="modal">
                    <div class="modal-content">
                        ...
                        <form id="commentForm" action="{{ route('task-timeline-overall-comment', ['taskID' => $task->id]) }}" method="post">
                            ...
                            <div class="form-group">
                                <label for="comment">Comment from trainee:</label>
